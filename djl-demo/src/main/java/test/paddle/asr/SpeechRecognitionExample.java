...
import test.paddle.asr.util.AudioProcess;
import test.paddle.asr.util.SpeechRecognition;
...
public final class SpeechRecognitionExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        NDArray audioFeature = AudioProcess.processUtterance(manager, "src/main/resources/test.wav");
        ...
        try (ZooModel<NDArray, Pair> model = criteria.loadModel();
            ...
            logger.info("input audio: {}", "src/main/resources/test.wav");
